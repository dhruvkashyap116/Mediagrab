...
async function checkStatus() {
    try {
        ...
        if (!data.cookies_file) {
            ...
            statusBar.innerHTML = `⚠️ <span>No cookies.txt — YouTube may block downloads</span><button class="btn-cookie" id="btnCookie">Upload cookies.txt</button>`;
...
calculator.prototype.and = function () {
